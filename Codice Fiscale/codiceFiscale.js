...
function codiceFiscale() {
    ...
    let cf = Consonanti(cognome) + Consonanti(nome) + data.charAt(2) + data.charAt(3) + month(data.charAt(5) + data.charAt(6)) + giorno(sesso) + luogoN(comune);
    cf += controllo(cf);
    alert(cf);
}
